...
public final class NoteDao_Impl implements NoteDao {
  ...
  public NoteDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfNote = new EntityInsertionAdapter<Note>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `notes_table` (`id`,`title`,`content`,`createdAt`,`modifiedAt`,`color`,`isPinned`) VALUES (nullif(?, 0),?,?,?,?,?,?)";
      }
    ...
    this.__updateAdapterOfNote = new EntityDeletionOrUpdateAdapter<Note>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `notes_table` SET `id` = ?,`title` = ?,`content` = ?,`createdAt` = ?,`modifiedAt` = ?,`color` = ?,`isPinned` = ? WHERE `id` = ?";
      }
  ...
  public LiveData<List<Note>> getAllNotes() {
    final String _sql = "SELECT * FROM notes_table ORDER BY isPinned DESC, modifiedAt DESC";
      ...
      public List<Note> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _tmpIsPinned = _tmp != 0;
            _item = new Note(_tmpId,_tmpTitle,_tmpContent,_tmpCreatedAt,_tmpModifiedAt,_tmpColor,_tmpIsPinned);
            _result.add(_item);
          }
          return _result;
        } finally {
  ...
  public LiveData<List<Note>> searchNotes(final String query) {
    final String _sql = "SELECT * FROM notes_table WHERE title LIKE ? OR content LIKE ? ORDER BY isPinned DESC, modifiedAt DESC";
  ...
  public LiveData<Note> getNoteById(final int noteId) {
    ...
    return __db.getInvalidationTracker().createLiveData(new String[] {"notes_table"}, false, new Callable<Note>() {
      @Override
      @Nullable
      public Note call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            _tmp = _cursor.getInt(_cursorIndexOfIsPinned);
            _tmpIsPinned = _tmp != 0;
            _result = new Note(_tmpId,_tmpTitle,_tmpContent,_tmpCreatedAt,_tmpModifiedAt,_tmpColor,_tmpIsPinned);
          } else {
            _result = null;
          }
          return _result;
